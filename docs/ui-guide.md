...
**Answer from** picker hold the right edge of the Chat header row
...
Everything (the default), Documents, or Images. It is a picker rather than a
toggle because it has three values and, unlike the two icon toggles beside
it, it changes what an answer is *made of* — under Images the model is shown
the stored pictures themselves, not only their descriptions. Choosing Images
