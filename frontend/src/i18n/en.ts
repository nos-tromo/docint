export const en = {
  ...
  'common.translate_all': 'Translate all findings',
  'common.translate_all_stop': 'Stop translating',
  'common.translate_all_retry': 'Retry translating',
  'common.translate_all_busy': 'Collecting the findings to translate…',
  'common.translate_all_confirm':
    'Translate {count} findings? This runs one translation at a time and can take several minutes.',
  'common.translate_all_progress': '{done} of {total} translated…',
  'common.translate_all_done': '{done} translated, {skipped} already translated',
  'common.translate_all_done_failed': '{done} translated, {failed} could not be translated',
  'common.translate_all_none': 'All findings are already translated',
  'common.translate_all_stopped': 'Stopped — {done} of {total} translated',
  'common.translate_all_failed': 'Translation is unavailable — click to retry',
  'common.translate_all_too_many': 'Too many findings to translate at once (limit {max}) — narrow the selection first',
  ...
  'chat.retrieval_target': 'Answer from',
  'chat.retrieval_target.all': 'Everything',
  'chat.retrieval_target.documents': 'Documents',
  'chat.retrieval_target.visual': 'Images',
  'chat.visual_source_type': 'Kind of image',
  'chat.visual_source.any': 'Any',
  'chat.visual_source.video': 'Video keyframes',
  'chat.visual_source.social': 'Social media keyframes',
  'chat.visual_source.image': 'Pictures and figures',
  'chat.visual_clip_file': 'Clip or file name',
  'chat.visual_time_from': 'From (m:ss)',
  'chat.visual_time_to': 'To (m:ss)',
  'chat.visual_pixels_missing':
    'The stored images could not be loaded, so this answer comes from their descriptions alone.',
  ...
  'report.select_aria': 'Select report',
  'report.choose': 'Choose a report…',
  ...
  'report.add_all': 'Add all findings to report',
