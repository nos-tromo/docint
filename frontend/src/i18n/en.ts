export const en = {
  ...
  'search.mode_hits': 'Hits',
  'search.mode_groups': 'Groups',
  'search.group_by': 'Group by',
  'search.group_by.author': 'Author',
  'search.group_by.author_id': 'Author ID',
  'search.group_by.network': 'Network',
  'search.group_by.posting_author': 'Posting author',
  'search.group_by.type': 'Type',
  'search.group_by.speaker': 'Speaker',
  'search.group_by.language': 'Language',
  'search.group_by.file_name': 'File',
  'search.groups_summary': '{groups} groups · {total} matching chunks',
  'search.groups_unassigned': '{count} without a value',
  'search.groups_capped': 'Showing the {limit} largest groups',
