...
export const de: Strings = {
  ...
  'search.mode_hits': 'Treffer',
  'search.mode_groups': 'Gruppen',
  'search.group_by': 'Gruppieren nach',
  'search.group_by.author': 'Autor',
  'search.group_by.author_id': 'Autor-ID',
  'search.group_by.network': 'Netzwerk',
  'search.group_by.posting_author': 'Beitragsautor',
  'search.group_by.type': 'Typ',
  'search.group_by.speaker': 'Sprecher',
  'search.group_by.language': 'Sprache',
  'search.group_by.file_name': 'Datei',
  'search.groups_summary': '{groups} Gruppen · {total} passende Abschnitte',
  'search.groups_unassigned': '{count} ohne Wert',
  'search.groups_capped': 'Die {limit} größten Gruppen',
