...
export const de: Strings = {
  ...
  'chat.retrieval_target': 'Antworten aus',
  'chat.retrieval_target.all': 'Allem',
  'chat.retrieval_target.documents': 'Dokumenten',
  'chat.retrieval_target.visual': 'Bildern',
  'chat.visual_source_type': 'Art des Bildes',
  'chat.visual_source.any': 'Beliebig',
  'chat.visual_source.video': 'Video-Keyframes',
  'chat.visual_source.social': 'Social-Media-Keyframes',
  'chat.visual_source.image': 'Bilder und Abbildungen',
  'chat.visual_clip_file': 'Clip- oder Dateiname',
  'chat.visual_time_from': 'Von (m:ss)',
  'chat.visual_time_to': 'Bis (m:ss)',
  'chat.visual_pixels_missing':
    'Die gespeicherten Bilder konnten nicht geladen werden; diese Antwort beruht allein auf ihren Beschreibungen.',
  ...
  'report.add_all': 'Alle Funde zum Bericht hinzufügen',
