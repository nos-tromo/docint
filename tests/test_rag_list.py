...
def test_list_documents() -> None:
    ...
    point1 = MagicMock()
    point1.payload = {
        "origin": {"filename": "file1.pdf", "file_hash": "hash1", "mimetype": "application/pdf"},
        "page": 1,
    ...
    point4 = MagicMock()
    point4.payload = {
        "origin": {"filename": "data.csv", "file_hash": "hash3", "filetype": "text/csv"},
        "table": {"n_rows": 150}
    }

    point5 = MagicMock()
    point5.payload = {
        "origin": {"filename": "audio.mp3", "file_hash": "hash4", "mimetype": "audio/mpeg"},
        "end_seconds": 125.5
    }
    ...
    rag.qdrant_client.scroll.side_effect = [
