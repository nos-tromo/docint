...
def test_encode_with_extra_fields_round_trips() -> None:
    """Encode with extra fields round trips."""
...
def test_decode_non_dict_payload_raises() -> None:
    """Decode non dict payload raises."""
